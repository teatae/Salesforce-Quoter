...
export var CoachmarkBase = React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
    ...
    return (React.createElement(PositioningContainer, __assign({ target: target, offsetFromTarget: BEAK_HEIGHT, finalHeight: finalHeight, ref: forwardedRef, onPositioned: onPositioned, bounds: useGetBounds() }, positioningContainerProps),
