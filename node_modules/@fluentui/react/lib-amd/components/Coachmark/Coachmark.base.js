define(["require", "exports", "tslib", "react", "../../Utilities", "../../Positioning", "./PositioningContainer/index", "./Beak/Beak", "../../common/DirectionalHint", "./Coachmark.styles", "../../FocusTrapZone", "@fluentui/react-hooks"], function (require, exports, tslib_1, React, Utilities_1, Positioning_1, index_1, Beak_1, DirectionalHint_1, Coachmark_styles_1, FocusTrapZone_1, react_hooks_1) {
    ...
    exports.CoachmarkBase = React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
        ...
        function useGetBounds() {
            var async = react_hooks_1.useAsync();
            var _a = React.useState(), bounds = _a[0], setBounds = _a[1];
            var updateAsyncPosition = function () {
                async.requestAnimationFrame(function () { return setBounds(getBounds(props)); });
            };
            React.useEffect(updateAsyncPosition);
            return bounds;
        }
        return (React.createElement(index_1.PositioningContainer, tslib_1.__assign({ target: target, offsetFromTarget: Beak_1.BEAK_HEIGHT, finalHeight: finalHeight, ref: forwardedRef, onPositioned: onPositioned, bounds: useGetBounds() }, positioningContainerProps),
